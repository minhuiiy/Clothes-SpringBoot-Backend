...
import com.clothes.backend.dto.request.LoginRequest;
import com.clothes.backend.dto.request.RegisterRequest;
import com.clothes.backend.dto.response.JwtResponse;
import com.clothes.backend.dto.response.MessageResponse;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody RegisterRequest signUpRequest) {
        ...
        // Tạo tài khoản người dùng mới, mặc định gán Role = USER
